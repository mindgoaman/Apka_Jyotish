...
/**
* @description:This is success modal
* @author:Vibhishan
   ...
   <View style={styles.centeredView}>
        ...
        <View style={styles.centeredView}>
            <View style={[styles.modalView,{
                    ...
                    width: props.passIsActivate?GlobalStyle.size.width/1.11:GlobalStyle.size.width/1.23
        }]}>
                <View>
                    <Image
                ...
                {props.modelButtonIcon
                ?
                <>
                    <TouchableOpacity
                        onPress={props.onPressModelButton}
                        activeOpacity={.6}
                        style={[styles.onPressButton,{paddingTop: props.passIsActivate?GlobalStyle.size.height/30:0}]}
                    >
                        <Image
                            source={props.modelButtonIcon}
                        />
                    </TouchableOpacity>
                    {props.passIsActivate&&<View style={[styles.cancelContainer,{paddingVertical:props.passIsActivate?0:12}]}>
                        <TouchableOpacity 
                ...
                <TouchableOpacity
                    ...
                    style={[styles.onPressTryAgain, {
                        borderColor: props?.borderColor
                                        ...
                                        props?.borderColor
                                        :
                                        Colors.borderColor.primaryColor
                        }]}
                >
  ...
  succesTitleTxt: { 
   ...
   successModelDescriptionTxt: {
    ...
    onPressTryAgain: {
         ...
         paddingHorizontal: GlobalStyle.size.width/5
    },
    onPressTxt: {
         fontSize: 16, 
